...
const DestinationGreenLineStations = () => {
  ...
  return (
    <Background>
      <View
        style={tw`flex-1 px-4 py-10 ${
          Platform.OS === "ios" ? "pt-10" : "" // Ajuste para iOS (espacio para la barra de estado)
        }`}
      >
        {/* Contenedor superior */}
        <View style={tw`mb-6`}>
...
export default DestinationGreenLineStations;
